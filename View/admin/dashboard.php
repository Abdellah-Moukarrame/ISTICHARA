    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-blue-900 text-white flex-shrink-0 hidden md:block">
            <div class="p-6">
                ...
                <!-- Navigation -->
                <nav class="space-y-2">
                    <a href="dashboard" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-blue-800 text-white transition-colors">
                    ...
                    <a href="stats" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800 text-blue-100 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
